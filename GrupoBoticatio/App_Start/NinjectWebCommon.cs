...
namespace DependencyInjection.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        {
            kernel.Bind<IRepositoryService>().To<RepositoryService>().InRequestScope();
            kernel.Bind<IRepositoryItemService>().To<RepositoryItemService>().InRequestScope();
        }
    }
}